...
export async function getUniswapPairContract(web3:Web3, address0:string,address1:string ) {
...
export async function getSushiSwapPairContract(web3:Web3, address0: string, address1:string) {
    return
}